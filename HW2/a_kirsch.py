...
def main():
    ...
    output1 = "./HW2/output/a_result_kirsch_lenna.png"
    output2 = "./HW2/output/a_result_kirsch_chessking.png"
    output3 = "./HW2/output/a_result_kirsch_breakfast.png"
    compare_output1 = "./HW2/output/a_compareirsch_lenna.png"
    compare_output2 = "./HW2/output/a_compare_kirsch_chessking.png"
    compare_output3 = "./HW2/output/a_compare_kirsch_breakfast.png"
